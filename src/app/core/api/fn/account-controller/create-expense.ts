...
export function createExpense(http: HttpClient, rootUrl: string, params: CreateExpense$Params, context?: HttpContext): Observable<StrictHttpResponse<SuccessResponseExpenseDetail>> {
