...
export class DonationDashboardNewComponent extends StandardTabbedDashboard<donationTab, PagedResultDonationDto> {
  ...
  protected get tabComponents(): { [key in donationTab]?: TabComponentInterface<PagedResultDonationDto> } {
    return {
