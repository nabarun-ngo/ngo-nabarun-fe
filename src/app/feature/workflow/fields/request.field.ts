...
export const getRequestDetailSection = (
    request: WorkflowRequest, refData: { [name: string]: KeyValue[]; }, isCreate: boolean = false, isDelegated: boolean = false, showAsWorkflow: boolean = false): DetailedView => {
    return {
        section_name: `${showAsWorkflow ? `Workflow` : `Request`} Detail`,
        ...
        content: [
            ...
            {
                field_name: `${showAsWorkflow ? `Workflow` : `Request`} Type`,
                ...
                form_input: {
                    ...
                    tagName: `select`,
                    inputType: ``,
                    placeholder: `Select ${showAsWorkflow ? `Workflow` : `Request`} type`,
            ...
            {
                field_name: `${showAsWorkflow ? `Workflow` : `Request`} Status`,
            ...
            {
                field_name: `${showAsWorkflow ? `Workflow` : `Request`} Description`,
...
export const getRequestAdditionalDetailSection = (m: WorkflowRequest | undefined, fields: FieldAttributeDto[], isCreate: boolean = false, showAsWorkflow: boolean = false): DetailedView => {
    return {
        section_name: `${showAsWorkflow ? `Workflow` : `Request`} Additional Data`,
        section_type: `key_value`,
