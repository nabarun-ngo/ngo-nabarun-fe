...
@Component({
    ...
    @if (data.headerText!=null) {
      <h1 mat-dialog-title class="font-bold">{{data.headerText}}</h1>
    }
    @if (data.headerTemplate!=null) {
    ...
    @if (data.buttonTemplate!=null) {
      <mat-dialog-actions class="overflow-hidden" align="end">
