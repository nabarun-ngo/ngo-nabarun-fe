                ...
                <div key={service.title} className="col-lg-4 col-md-6">
                  <div className="service-card h-100">
                    ...
                    <div className="service-content">
                      ...
                      <a className="btn btn-outline-primary w-100" href={detailUrl}>
                        <i className="fas fa-info-circle me-2"></i><span>{service.button.label}</span>
                      </a>
                    </div>
                    <div className="service-overlay">
                      <div className="overlay-content">
                        <h4 className="h5 text-white mb-3">{service.overlay.title}</h4>
